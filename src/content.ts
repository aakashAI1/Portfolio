export const content = {
  ...
  links: {
    ...
    instagram: 'https://www.instagram.com/aakash_chyy?igsh=NzkwYzI4d3FqeGt0&utm_source=qr',
  },
  about: {
  ...
  achievements: [
    '3rd place in Bootcamp ’20 and Ideathon ’25 (college innovation events).',
    'International Dance Council (CID), Paris — Hip Hop Dance Level 1 (150-hour module).',
    'Advanced Pranic Healing certification (energy healing techniques).',
  ],
} as const

export type FeaturedProject = (typeof content.featuredProjects)[number]
